...
let url_arr = [];
url_arr.push(`https://api.npoint.io/f04641224f3984e272a1`);
url_arr.push(`https://api.npoint.io/f7d54c0c3594bd850655`); 
url_arr.push(`https://api.npoint.io/c0a27f89f6f370003c6b`);
let vals = [];
let filtered = [];
